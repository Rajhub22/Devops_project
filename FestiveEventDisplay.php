...
if (isset($_GET['delete_id'])) {
    ...
    $delete_stmt = $conn->prepare("DELETE FROM festive_events WHERE id = ?");
...
$sql = "SELECT * FROM festive_events";
...
<header>
    ...
    <!-- Menu Button to open Menu.html -->
    <a href="Menu.html"><button class="menu-btn">Menu</button></a>

    <section class="event-section">
        <h1>Festive Event List</h1>
            ...
            <table>
                ...
                <?php while ($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td><?php echo $row['todo_list']; ?></td>
                        <td><?php echo $row['materials']; ?></td>
                        
                        <td>
                            <!-- Delete Button -->
                            <a href="FestiveEventDisplay.php?delete_id=<?php echo $row['id']; ?>" class="delete-btn" onclick="return confirm('Are you sure you want to delete this record?')">Delete</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
